...
public class SimpleComponent extends JComponent {
	...
	public SimpleComponent(List<Isoligne> listIsos, Grille grille, int w, int h){
	...
	public SimpleComponent(ArrayList<List<Point2D.Double[]>> listIsos2D, Grille grille, int w, int h){
