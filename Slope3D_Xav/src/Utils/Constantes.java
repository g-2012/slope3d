...
public class Constantes {
	...
	public static final byte OBJ_ISOLIGNES = 2; // Seules les isolignes sont affichées
	public static final byte OBJ_TOUT = 3; // Le MNT et les isolignes sont tous deux affichés
