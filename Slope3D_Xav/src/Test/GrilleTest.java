...
// DEPRECATED
public class GrilleTest {  // MNT fictif cr�� pour les tests
	...
	public 		double 		x0   = 0	; 		// abcsisse  du coin sup�rieur gauche
	public 		double 		y0   = 0	; 		// ordonn�e  du coin sup�rieur gauche
