...
public abstract class Camera {
	...
	private static double champVertical; // Champ de vision (angle en degrés) dans la direction verticale (de l'écran).
    ...
    private static double profProche; // Profondeur (en unités de distance de l'environnement 3D) du plus proche plan visible. (Doit être strictement positif)
    private static double profLoin; // Profondeur du plan visible le plus éloigné. (Doit être supérieur à profProche) 
     ...
     */
    public static void setCameraOrbite(GL2 gl, GLU glu, GLJPanel pan, double angleRot /* Angle de rotation en radians de la caméra en orbite*/, double zPlanOrbital, double rOrbite, double[] coordCentreVue ) {
