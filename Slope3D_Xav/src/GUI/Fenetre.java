...
public class Fenetre extends JFrame { /**
	...
	private JMenu mIsolignes; // Menu permettant d'ouvrir dans une fenêtre séparée la carte des isolignes en 2D
	...
	public Fenetre() {
		...
		/*
		 * Localisation, particulièrement pour la langue des textes par défaut des boutons.
		 */
		this.setLocale(Locale.FRANCE);
		Constantes.langueFR();
		
		/*
		 * Extraction des dimensions de l'écran sur lequel s'exécute le programme.
		 */
		...
		panEnv = new Panneau3D(bandeauMenu.getMenuReglage(), new Dimension(dimFenetre.width-250, dimFenetre.height-25-20)); // Cr�ation du panneau contenant l'environnement 3D.
