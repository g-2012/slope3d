...
public class PanneauControleRotation extends JPanel {
	/*
	 * Panneau de contrôle qui permet à l'utilisateur d'effectuer différentes
	 * opérations de rotation de la caméra suivant le type de vue choisie dans
	 * le menu de réglages :
	 *  - En vue orbitale, réglage du sens et de la vitesse
	 * de rotation
	 *  - En vue de dessus, aucune rotation autorisée - En vue libre,
	 * rotation verticale ou horizontale de la caméra, et modification de la
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2116064159072301532L;

	/*
	 * Attributs : boutons
	 */
	JButton bSensHora, bSensAnti, // Boutons de choix du sens : respectivement
									// horaire et antihoraire
			bVitPlus, bVitMoins, // Vitesse de rotation / sensibilité des
									// commandes de rotation
			bHPlus, bHMoins, // Rotation par rapport au plan vertical (dans le
								// plan horizontal)
			bVPlus, bVMoins; // Rotation par rapport au plan horizontal (dans le
								// plan vertical)
	/*
	 * Autres attributs
	 */
	 ...
	 * Constructeur
	 */
	public PanneauControleRotation(MenuReglage Reglages /*
														 * permet de connaitre
														 * les valeurs des
														 * réglages
														 */, Dimension d) {
		...
		if (mReg.getChoixCam() == Constantes.CAM_DESSUS) { // Vue du dessus
		...
		} else if (mReg.getChoixCam() == Constantes.CAM_ORBITE) { // Caméra en
																	// orbite
			...
			bSensAnti.setEnabled(false); // Commande inutile ici
			bSensHora.setEnabled(false); // Commande inutile ici
			bVitMoins.setEnabled(true);
			bVitPlus.setEnabled(true);
						...
						layout.createParallelGroup(
								...
								.addGroup(
										layout.createSequentialGroup()
												...
												.addComponent(bHPlus, 60, 60,
														60)
												.addComponent(vHor, 25, 25, 25)
												.addComponent(bHMoins, 60, 60,
														60))
								.addGap(10)
								.addGroup(
										layout.createSequentialGroup()
												.addComponent(tVer, 25, 25, 25)
												.addComponent(bVPlus, 60, 60,
														60)
												.addComponent(vVer, 25, 25, 25)
												.addComponent(bVMoins, 60, 60,
														60)))
				.addGap(15)
				.addGroup(
						layout.createParallelGroup(
								...
								.addGroup(
										layout.createSequentialGroup()
												...
												.addComponent(bSensHora, 60,
														60, 60)
												.addComponent(vSens, 25, 25, 25)
												.addComponent(bSensAnti, 60,
														60, 60))
								.addGap(10)
								.addGroup(
										layout.createSequentialGroup()
												.addComponent(tVit, 25, 25, 25)
												.addComponent(bVitPlus, 60, 60,
														60)
												.addComponent(vVit, 25, 25, 25)
												.addComponent(bVitMoins, 60,
														60, 60)))
				.addContainerGap(20, Short.MAX_VALUE));
